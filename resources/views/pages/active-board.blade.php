                    ...
                    <article class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition duration-200 hover:-translate-y-1 hover:shadow-md">
                        ...
                        <div class="space-y-3 p-5">
                            <div>
                                ...
                                <p class="mt-1 text-sm font-medium text-emerald-700">{{ $item->jabatan ?: 'Anggota' }}</p>
                            </div>
                            ...
                            <div class="space-y-1 text-sm text-slate-600">
                                ...
                                <p><span class="font-semibold text-slate-800">Ambalan:</span> {{ $item->ambalan ?: '-' }}</p>
                            </div>
                        </div>
                    </article>
                @endforeach
