                    ...
                    <div>
                        ...
                        <div class="space-y-1 mt-2">
                            <a href="{{ route('pembina') }}"
                                class="block w-full rounded-lg px-3 py-1.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-950 {{ request()->routeIs('pembina') ? 'bg-slate-100 font-bold text-slate-950' : '' }}">
                                <span>Pembina</span>
                            </a>

                            <a href="{{ route('dewan-kehormatan') }}"
                                class="block w-full rounded-lg px-3 py-1.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-950 {{ request()->routeIs('dewan-kehormatan') ? 'bg-slate-100 font-bold text-slate-950' : '' }}">
                                <span>Dewan Kehormatan</span>
                            </a>

                            <a href="{{ route('dewan-ambalan') }}"
                                class="block w-full rounded-lg px-3 py-1.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-950 {{ request()->routeIs('dewan-ambalan') ? 'bg-slate-100 font-bold text-slate-950' : '' }}">
                                <span>Dewan Ambalan</span>
                            </a>

                            <a href="{{ route('anggota-dewan') }}"
                                class="block w-full rounded-lg px-3 py-1.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-950 {{ request()->routeIs('anggota-dewan') ? 'bg-slate-100 font-bold text-slate-950' : '' }}">
