            ...
            <div class="order-1 md:col-span-2 lg:order-2 lg:col-span-1 space-y-6">
                <article class="overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-sm transition duration-300 hover:shadow-md">
                    ...
                    <div class="overflow-hidden">
                        <img src="{{ asset('images/hero/imagehero1.png') }}" alt="Membangun Karakter Melalui Disiplin Kepanduan" class="w-full h-[180px] object-cover object-top transition duration-500 hover:scale-105">
                    </div>
                ...
                <article class="overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-sm transition duration-300 hover:shadow-md">
                    ...
                    <div class="overflow-hidden">
                        <img src="{{ asset('images/hero/imagehero6.png') }}" alt="Kegiatan Peningkatan Keterampilan Kepanduan" class="w-full h-[180px] object-cover object-top transition duration-500 hover:scale-105">
                    </div>
                    <div class="px-6 py-4 text-left">
            ...
            <div class="space-y-4 order-2 lg:order-1">
                ...
                <article class="group overflow-hidden rounded-xl border border-slate-300 bg-white shadow-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-md cursor-pointer">
                    <div class="flex flex-col gap-3 p-4 md:flex-row md:items-center">
                        ...
                        <div class="h-32 w-full overflow-hidden bg-slate-100 md:w-32 md:h-32">
                            <img src="{{ asset('images/hero/imagehero2.png') }}" alt="Ekspedisi Alam" class="h-full w-full object-cover transition duration-500 group-hover:scale-105">
                        </div>
                    </div>
                </article>
                ...
                <article class="group overflow-hidden rounded-xl border border-slate-300 bg-white shadow-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-md cursor-pointer">
                    <div class="flex flex-col gap-3 p-4 md:flex-row md:items-center">
                        ...
                        <div class="h-32 w-full overflow-hidden bg-slate-100 md:w-32 md:h-32">
                            <img src="{{ asset('images/hero/imagehero3.png') }}" alt="Penghijauan Lapangan" class="h-full w-full object-cover transition duration-500 group-hover:scale-105">
                        </div>
                    </div>
                </article>
            </div>
