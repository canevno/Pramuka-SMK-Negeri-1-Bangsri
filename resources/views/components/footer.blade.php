    ...
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
        <div class="grid grid-cols-2 gap-10 lg:grid-cols-[1.7fr_1fr_1fr_1fr]">
            ...
            <div class="col-span-1">
                    ...
                    <li><a href="{{ route('home') }}" class="text-sm font-semibold text-white hover:text-slate-300 transition-colors uppercase tracking-wide">Beranda</a></li>
                    <li><a href="{{ route('about') }}" class="text-sm font-semibold text-white hover:text-slate-300 transition-colors uppercase tracking-wide">Tentang Kami</a></li>
                    <li><a href="{{ route('gallery') }}" class="text-sm font-semibold text-white hover:text-slate-300 transition-colors uppercase tracking-wide">Galeri</a></li>
                    <li><a href="{{ route('contact') }}" class="text-sm font-semibold text-white hover:text-slate-300 transition-colors uppercase tracking-wide">Kontak</a></li>
                </ul>
            </div>
            ...
            <div class="col-span-1">
                    ...
                    <ul class="space-y-3 text-sm text-slate-200">
                    <li><a href="{{ route('pembina') }}#anggota-dewan" class="text-sm font-semibold text-white hover:text-slate-300 transition-colors uppercase tracking-wide">Anggota Dewan</a></li>
                    <li><a href="{{ route('achievement') }}" class="text-sm font-semibold text-white hover:text-slate-300 transition-colors uppercase tracking-wide">Prestasi</a></li>
                    <li><a href="{{ route('event') }}" class="text-sm font-semibold text-white hover:text-slate-300 transition-colors uppercase tracking-wide">Event</a></li>
                    <li><a href="{{ route('news') }}" class="text-sm font-semibold text-white hover:text-slate-300 transition-colors uppercase tracking-wide">Berita</a></li>
                </ul>
            </div>
                    ...
                    <ul class="grid grid-cols-3 gap-3 justify-items-center text-sm lg:grid-cols-2 lg:gap-4 lg:-mt-3">
                        ...
                        <li class="order-2 lg:order-2">
                            <a href="https://wa.me/6281234567890" target="_blank" class="inline-flex w-full max-w-[260px] justify-center items-center gap-2 px-3 py-2 text-slate-200 transition hover:text-white">
                                <img src="{{ asset('whatsapp.svg') }}" alt="WhatsApp" class="h-5 w-5 brightness-0 invert" />
                                <span>WhatsApp</span>
                            </a>
                        </li>
                        ...
                        <li class="order-5 lg:order-4">
                            <a href="https://x.com/scouteskasaba" target="_blank" class="inline-flex w-full max-w-[260px] justify-center items-center gap-2 px-3 py-2 text-slate-200 transition hover:text-white">
                                <img src="{{ asset('x.svg') }}" alt="X" class="h-5 w-5 brightness-0 invert" />
                                <span>Twitter</span>
                            </a>
                        </li>
                        ...
                        <li class="order-4 lg:order-6">
                            <a href="https://tiktok.com/pramukasmkn1bangsri" target="_blank" class="inline-flex w-full max-w-[260px] justify-center items-center gap-2 px-3 py-2 text-slate-200 transition hover:text-white">
                                <img src="{{ asset('tiktok.svg') }}" alt="TikTok" class="h-5 w-5 brightness-0 invert" />
                                <span>TikTok</span>
                            </a>
                        </li>
                    </ul>
