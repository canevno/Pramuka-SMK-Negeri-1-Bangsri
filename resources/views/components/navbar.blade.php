        ...
        <div class="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-center h-16 gap-4 relative">
                ...
                <div class="absolute left-0 flex items-center justify-center gap-2 lg:hidden">
                    <img src="{{ asset('images/logos/smklogo.png') }}" alt="Logo SMK" class="h-11 w-11 object-contain bg-transparent p-0 shadow-none">
        ...
        <div class="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-center h-14">
                <div class="flex gap-8">
                    <a href="{{ route('home') }}" class="text-sm font-semibold text-gray-900 transition-colors uppercase tracking-wide hover:text-slate-900 dark:text-white dark:hover:text-blue-300">BERANDA</a>
                    <div
                        class="relative"
                    ...
                    >
                        ...
                        >
                            <a href="{{ route('absensi.index') }}" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Absensi</a>
                            <a href="{{ route('pendaftaran-bantara') }}" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Pendaftaran Bantara</a>
                            <a href="{{ route('pendaftaran-laksana') }}" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Pendaftaran Laksana</a>
                        </div>
                    </div>
                    <div
                        class="relative"
                    ...
                    >
                        ...
                        <div
                            ...
                            class="absolute left-0 top-full z-50 mt-2 w-48 rounded-none border border-slate-300 bg-white p-2 shadow-lg dark:border-slate-600 dark:bg-gray-900"
                        >
                            <a href="{{ route('about') }}" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Sejarah</a>
                            <a href="{{ route('visi-misi') }}" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Visi &amp; Misi</a>
                            <a href="{{ route('ambalan') }}" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Ambalan</a>
                        </div>
                    </div>
                    <div
                        class="relative"
                    ...
                    >
                        ...
                        >
                            ...
                            <a href="{{ route('anggota-dewan') }}" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Anggota Dewan</a>
                            <a href="{{ route('mitra') }}" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Mitra</a>
                    ...
                    >
                        ...
                        >
                            <a href="{{ route('news') }}" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Berita</a>
                            <a href="{{ route('gallery') }}" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Galeri</a>
                        </div>
                    </div>
        ...
        >
            <div class="px-4 py-4 sm:px-6">
                ...
                <div class="mt-6 space-y-3 pb-6">
                    <a href="{{ route('home') }}" @click="mobileMenuOpen = false" class="block px-4 py-3 text-base font-semibold uppercase text-gray-900 transition-colors hover:text-slate-900 dark:text-white dark:hover:text-slate-200">BERANDA</a>
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 overflow-hidden">
                        ...
                        <div x-show="mobileProfilOpen" x-transition class="space-y-1 border-t border-slate-200 dark:border-slate-800 px-4 py-2">
                            <a href="{{ route('about') }}" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Sejarah</a>
                            <a href="{{ route('visi-misi') }}" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Visi &amp; Misi</a>
                            <a href="{{ route('ambalan') }}" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Ambalan</a>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 overflow-hidden">
                        ...
                        <div x-show="mobileAdminOpen" x-transition class="space-y-1 border-t border-slate-200 dark:border-slate-800 px-4 py-2">
                            <a href="{{ route('absensi.index') }}" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Absensi</a>
                            <a href="{{ route('pendaftaran-bantara') }}" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Pendaftaran Bantara</a>
                            <a href="{{ route('pendaftaran-laksana') }}" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Pendaftaran Laksana</a>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 overflow-hidden">
                        ...
                        <div x-show="mobileOrgOpen" x-transition class="space-y-1 border-t border-slate-200 dark:border-slate-800 px-4 py-2">
                            ...
                            <a href="{{ route('anggota-dewan') }}" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Anggota Dewan</a>
                            <a href="{{ route('mitra') }}" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Mitra</a>
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 overflow-hidden">
                        ...
                        <div x-show="mobilePublikasiOpen" x-transition class="space-y-1 border-t border-slate-200 dark:border-slate-800 px-4 py-2">
                            <a href="{{ route('news') }}" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Berita</a>
                            <a href="{{ route('gallery') }}" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Galeri</a>
                        </div>
                    </div>
