            ...
            <tbody>
                @forelse ($registrations as $index => $item)
                    ...
                    <tr data-rt="{{ e($item->rt) }}" data-rw="{{ e($item->rw) }}" data-kecamatan="{{ e($item->kecamatan) }}" data-kabupaten="{{ e($item->kabupaten) }}" data-ttl="{{ e($item->tempat_tanggal_lahir) }}" data-motivasi="{{ e($item->motivasi) }}" class="bg-white border-b hover:bg-gray-50">
                        <td class="py-4 px-4 font-medium text-gray-900">{{ $registrations->firstItem() + $index }}</td>
                        ...
                        <td class="py-4 px-4 align-middle">
                            ...
                            @endphp
                            @if($hasSurat)
                                <a href="{{ route('admin.pendaftaran-laksana.download', $item->id) }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-100 rounded hover:bg-blue-200 whitespace-nowrap min-w-24">
                                    Download Berkas
                                </a>
                            @else
