            ...
            <div class="sidebar-sticky w-60 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0a0a0a]">
                ...
                <div class="sidebar-fixed-header h-14 flex items-center px-5 border-b border-gray-200 dark:border-gray-800">
                    <div class="flex items-center space-x-2.5">
                        <div class="w-7 h-7 rounded-lg bg-indigo-600 flex items-center justify-center text-white font-bold text-xs shadow-sm shadow-indigo-500/30">S</div>
                        <div>
                                ...
                                <li>
                                    <a href="{{ route($item['route']) }}" 
                                       ...
                                       {{ $active 
                                        ...
                                        <svg class="mr-2.5 h-4 w-4 flex-shrink-0 {{ $active ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-400 group-hover:text-gray-500 dark:group-hover:text-gray-300' }}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                            <path d="{{ $item['icon'] }}"/>
                                        </svg>
                                        {{ $item['label'] }}
                                    </a>
            ...
            <header class="navbar-sticky h-16 flex items-center justify-between px-6 bg-white/90 dark:bg-[#0a0a0a]/90">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        ...
                        <div x-show="open" x-transition class="absolute right-0 mt-2 w-80 bg-white dark:bg-[#0a0a0a] rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 z-50 overflow-hidden">
                            <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
                                <h3 class="text-xs font-bold text-gray-900 dark:text-white uppercase tracking-wider">Notifikasi</h3>
                                @if(isset($unreadCount) && $unreadCount > 0)
                                    <span class="text-[10px] text-indigo-600 dark:text-indigo-400 font-semibold">{{ $unreadCount }} Belum Dibaca</span>
                                @endif
                            </div>
                    ...
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        ...
                        <div x-show="open" x-transition class="absolute right-0 mt-2 w-64 bg-white dark:bg-[#0a0a0a] rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 z-50 overflow-hidden">
                            <div class="p-4 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/20 dark:to-purple-950/20">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-sm font-bold shadow-md">A</div>
                                    <div class="flex-1 min-w-0">
