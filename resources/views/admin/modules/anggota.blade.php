                        ...
                        <tr id="edit-anggota-{{ $item->id }}" class="hidden bg-slate-50">
                            <td colspan="5" class="px-4 py-4">
                                <form action="{{ route('admin.anggota.update', $item) }}" method="POST" enctype="multipart/form-data" class="grid gap-3 md:grid-cols-2">
                                    ...
                                    <input type="text" name="nama" value="{{ old('nama', $item->nama) }}" class="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm md:col-span-2" placeholder="Nama lengkap" required>
                                    ...
                                    <textarea name="bio" rows="3" class="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm md:col-span-2" placeholder="Deskripsi singkat">{{ old('bio', $item->bio) }}</textarea>
