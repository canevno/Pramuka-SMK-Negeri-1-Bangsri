                ...
                <tbody class="divide-y divide-slate-200 bg-white">
                    @forelse($partners ?? [] as $partner)
                        <tr>
                            ...
                            <td class="px-4 py-3">{{ $partner->jabatan }}</td>
                            <td class="px-4 py-3">
                                <span class="rounded-full px-2.5 py-1 text-[10px] font-semibold {{ $partner->is_active ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-200 text-slate-700' }}">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <button type="button" onclick="document.getElementById('edit-mitra-{{ $partner->id }}').classList.toggle('hidden')" class="rounded-lg border border-indigo-200 bg-indigo-50 px-2.5 py-1.5 text-[10px] font-semibold text-indigo-700 hover:bg-indigo-100">
                                        Edit
                                    </button>
                        ...
                        <tr id="edit-mitra-{{ $partner->id }}" class="hidden bg-slate-50">
                            <td colspan="4" class="px-4 py-4">
                                <form action="{{ route('admin.mitra.update', $partner) }}" method="POST" enctype="multipart/form-data" class="grid gap-3 md:grid-cols-2">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $partner->name) }}" class="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm" placeholder="Nama lengkap" required>
                                    <input type="text" name="jabatan" value="{{ old('jabatan', $partner->jabatan) }}" class="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm" placeholder="Jabatan" required>
                                    ...
                                    <input type="number" name="sort_order" value="{{ old('sort_order', $partner->sort_order ?? 0) }}" min="0" class="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm" placeholder="Urutan">
                                    <textarea name="bio" rows="3" class="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm md:col-span-2" placeholder="Deskripsi singkat">{{ old('bio', $partner->bio) }}</textarea>
