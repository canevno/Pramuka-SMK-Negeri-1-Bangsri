                ...
                @foreach($formFields as $field)
                    <label class="block {{ $field['full'] ?? false ? 'md:col-span-2' : '' }}">
                        ...
                        @if(($field['type'] ?? 'text') === 'textarea')
                            <textarea rows="4" class="w-full rounded-xl border border-gray-200 bg-white px-3.5 py-2.5 text-sm text-gray-900 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 dark:border-gray-800 dark:bg-[#111111] dark:text-gray-100 dark:focus:border-emerald-500" placeholder="{{ $field['placeholder'] ?? '' }}"></textarea>
                        ...
                        @else
                            <input type="{{ $field['type'] ?? 'text' }}" class="w-full rounded-xl border border-gray-200 bg-white px-3.5 py-2.5 text-sm text-gray-900 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 dark:border-gray-800 dark:bg-[#111111] dark:text-gray-100 dark:focus:border-emerald-500" placeholder="{{ $field['placeholder'] ?? '' }}" />
                        @endif
                    </label>
                @endforeach
