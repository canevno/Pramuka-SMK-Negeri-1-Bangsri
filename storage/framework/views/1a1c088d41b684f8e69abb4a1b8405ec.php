...
<div class="w-full">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 md:gap-12">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3 sm:gap-x-8 sm:gap-y-2">
                    ...
                    <div class="flex items-center gap-2.5 text-sm text-gray-700 dark:text-gray-300">
                        ...
                        <span class="font-medium"><?php echo e($nextEvent['location']); ?></span>
                    </div>
                    ...
                    <div class="flex items-center gap-2.5 text-sm text-gray-700 dark:text-gray-300">
                        ...
                        <span class="font-medium"><?php echo e($nextEvent['date_formatted']); ?></span>
                    </div>

                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nextEvent['guide_url']): ?>
                    <a href="<?php echo e($nextEvent['guide_url']); ?>" class="flex items-center gap-2.5 text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">
            ...
            <div class="flex-shrink-0 flex items-center gap-4 md:flex-col md:items-center">
                <div class="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 flex items-center justify-center flex-shrink-0">
                    <img src="<?php echo e(asset('images/logokegiatan2.png')); ?>" 
                         alt="Logo Kegiatan" 
    ...
    <script>
        (function () {
            const target = new Date("<?php echo e($nextEvent['datetime_js']); ?>");
