...
<body>
    <div class="card">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('absensi_verify_error')): ?>
            <div class="alert"><?php echo e(session('absensi_verify_error')); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <form action="<?php echo e(route('absensi.verify')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Lenovo\Pramuka01\resources\views\absensi\verify.blade.php ENDPATH**/ ?>