    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div class="text-center md:text-left">
                <p class="text-xs font-bold uppercase tracking-[0.25em] text-slate-900 dark:text-white">Prestasi Nasional</p>
                <h1 class="mt-3 text-4xl font-black tracking-tight text-slate-900 dark:text-white">Capaian Tingkat Nasional</h1>
            </div>
