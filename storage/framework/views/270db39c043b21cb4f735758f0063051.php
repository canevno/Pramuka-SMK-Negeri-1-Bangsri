    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 lg:p-10">
            ...
            <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
                <a href="<?php echo e(route('pembina')); ?>" class="group rounded-2xl border border-slate-200 bg-slate-50 p-4 transition hover:-translate-y-1 hover:border-[#0D1B2A] hover:shadow-md">
                    <div class="mb-4 overflow-hidden rounded-xl">
                        <img src="<?php echo e(asset('images/visimisi/visimisi1.jpg')); ?>" alt="Pembina" class="h-44 w-full object-cover transition duration-300 group-hover:scale-105">
                    </div>
                ...
                <a href="<?php echo e(route('anggota-dewan')); ?>" class="group rounded-2xl border border-slate-200 bg-slate-50 p-4 transition hover:-translate-y-1 hover:border-[#0D1B2A] hover:shadow-md">
                    <div class="mb-4 overflow-hidden rounded-xl">
            ...
            <div class="mt-8 rounded-2xl border border-slate-200 bg-slate-100 p-5 sm:p-6">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <a href="<?php echo e(route('mitra')); ?>" class="inline-flex items-center justify-center rounded-xl bg-[#0D1B2A] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#142334]">Lihat Mitra</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Pramuka01\resources\views/pages/organisasi.blade.php ENDPATH**/ ?>