<section id="prestasi" class="py-16 sm:py-20 bg-white dark:bg-gray-950 transition-colors duration-200">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <a href="<?php echo e(route('prestasi.ranting')); ?>" class="rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-gray-900 px-4 py-3 text-center text-sm font-semibold text-slate-800 dark:text-slate-200 transition hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900">
                Tingkat Ranting
            </a>
            <a href="<?php echo e(route('prestasi.cabang')); ?>" class="rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-gray-900 px-4 py-3 text-center text-sm font-semibold text-slate-800 dark:text-slate-200 transition hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900">
                Tingkat Cabang
            </a>
            <a href="<?php echo e(route('prestasi.jateng')); ?>" class="rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-gray-900 px-4 py-3 text-center text-sm font-semibold text-slate-800 dark:text-slate-200 transition hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900">
                Tingkat Jateng
            </a>
            <a href="<?php echo e(route('prestasi.nasional')); ?>" class="rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-gray-900 px-4 py-3 text-center text-sm font-semibold text-slate-800 dark:text-slate-200 transition hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900">
                Tingkat Nasional
            </a>
        </div>
