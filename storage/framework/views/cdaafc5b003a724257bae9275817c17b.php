        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="flex items-center gap-3 px-5 py-4 border-b border-slate-100 dark:border-slate-800">
                    <div class="relative">
                        <img src="<?php echo e(asset('images/logos/smklogo.png')); ?>" alt="Logo" class="h-9 w-9 rounded-lg object-cover ring-2 ring-slate-100 dark:ring-slate-800" />
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route($item['route'])); ?>" 
                               class="group relative flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-all duration-200 
                                ...
                                <svg class="h-5 w-5 shrink-0 transition-colors <?php echo e($active ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300'); ?>" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        ...
                        <div x-show="openNotif" @click.away="openNotif = false" x-transition 
                            ...
                            <div id="notif-list" class="max-h-72 overflow-y-auto custom-scrollbar divide-y divide-slate-100 dark:divide-slate-800">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $unreadNotifications ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="cursor-pointer px-4 py-3 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50 <?php echo e(!$notif->is_read ? 'bg-indigo-50/50 dark:bg-indigo-500/5' : ''); ?>">
                                        <div class="flex items-start gap-3">
                                            <span class="mt-1.5 h-2 w-2 shrink-0 rounded-full <?php echo e($notif->type === 'warning' ? 'bg-amber-500' : ($notif->type === 'success' ? 'bg-emerald-500' : 'bg-blue-500')); ?>"></span>
                                            <div class="flex-1 min-w-0">
                                                <p class="text-xs font-semibold text-slate-900 dark:text-slate-100"><?php echo e($notif->title); ?></p>
                                                <p class="mt-0.5 text-xs text-slate-500 dark:text-slate-400 line-clamp-2"><?php echo e($notif->message); ?></p>
                                                <time class="notif-time mt-1.5 block text-[10px] font-medium text-slate-400 dark:text-slate-500" datetime="<?php echo e($notif->created_at->toIso8601String()); ?>" data-time="<?php echo e($notif->created_at->toIso8601String()); ?>"><?php echo e($notif->created_at->diffForHumans()); ?></time>
                                            </div>
                                        </div>
                                    </div>
