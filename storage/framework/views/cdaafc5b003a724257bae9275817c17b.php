        ...
        <aside class="sticky top-0 self-start h-screen w-[250px] bg-white dark:bg-[#121215] border-r border-gray-200/80 dark:border-zinc-800/80 flex flex-col justify-between p-3.5 select-none shrink-0 z-20 transition-colors duration-200">
            ...
            <div class="flex flex-col gap-4 overflow-y-auto custom-scrollbar min-h-0 pr-0.5">
                ...
                <div class="flex items-center gap-3 px-1.5 pt-1.5 pb-2 border-b border-gray-100 dark:border-zinc-800/60">
                    <img src="<?php echo e(asset('images/logos/smklogo.png')); ?>" alt="Admin Profile" class="w-8 h-8 rounded-full object-cover shrink-0 border border-gray-200/80 dark:border-zinc-700/80 shadow-2xs" />
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route($item['route'])); ?>" 
                               class="group flex items-center justify-between px-2.5 py-1.5 rounded-lg text-[13px] font-medium transition-all duration-150 <?php echo e($active ? 'bg-gray-100 dark:bg-zinc-800/80 text-gray-900 dark:text-zinc-100 font-semibold' : 'text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-zinc-100 hover:bg-gray-50 dark:hover:bg-zinc-800/40'); ?>">
                                <div class="flex items-center gap-2.5 min-w-0">
                                    <svg class="w-[18px] h-[18px] shrink-0 transition-colors <?php echo e($active ? 'text-gray-900 dark:text-zinc-100' : 'text-gray-400 dark:text-zinc-500 group-hover:text-gray-600 dark:group-hover:text-zinc-300'); ?>" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($item['icon']); ?>"/>
                                    </svg>
                                    <span class="truncate tracking-tight"><?php echo e($item['label']); ?></span>
                                </div>
                            </a>
                        ...
                        <div x-show="openNotif" @click.away="openNotif = false" x-transition class="absolute right-0 mt-2 w-96 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 z-50 overflow-hidden" style="display: none;">
                            <div class="p-3 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($unreadCount) && $unreadCount > 0): ?>
                                    <form method="POST" action="<?php echo e(route('admin.notifications.readAll')); ?>">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div id="notif-list" class="max-h-64 overflow-y-auto divide-y divide-gray-100 dark:divide-gray-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $unreadNotifications ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="p-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors <?php echo e(!$notif->is_read ? 'bg-emerald-50/30 dark:bg-emerald-950/20' : ''); ?>">
                                        <div class="flex items-start gap-2">
                                            <span class="w-2 h-2 mt-1.5 rounded-full <?php echo e($notif->type === 'warning' ? 'bg-amber-500' : ($notif->type === 'success' ? 'bg-emerald-500' : 'bg-blue-500')); ?>"></span>
                                            <div class="flex-1">
                                                <p class="text-xs font-semibold text-gray-800 dark:text-gray-200"><?php echo e($notif->title); ?></p>
                                                <p class="text-[11px] text-gray-500 dark:text-gray-400 mt-0.5"><?php echo e($notif->message); ?></p>
                                                <time class="notif-time text-[9px] text-gray-400 mt-1 block" datetime="<?php echo e($notif->created_at->toIso8601String()); ?>" data-time="<?php echo e($notif->created_at->toIso8601String()); ?>"><?php echo e($notif->created_at->diffForHumans()); ?></time>
                                            </div>
                                        </div>
                                    </div>
