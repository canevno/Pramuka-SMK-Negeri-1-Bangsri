                        ...
                        <div x-show="open" x-cloak class="hidden absolute right-0 mt-2 w-80 bg-white dark:bg-[#0a0a0a] rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 z-50 overflow-hidden">
                            ...
                            <div class="max-h-96 overflow-y-auto custom-scrollbar">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $unreadNotifications ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <a href="<?php echo e(route('admin.notifications.visit', $notif)); ?>" class="block px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors border-b border-gray-100 dark:border-gray-800 last:border-0">
                            ...
                            <div class="border-t border-gray-100 px-3 py-2 dark:border-gray-800">
                                <a href="<?php echo e(route('admin.notifications.index')); ?>" class="block rounded-lg px-3 py-2 text-center text-[10px] font-semibold text-slate-700 transition hover:bg-slate-100 dark:text-slate-200 dark:hover:bg-slate-900">
                        ...
                        <?php else: ?>
                            ...
                            <li>
                                <a href="<?php echo e(route($item['route'])); ?>" wire:navigate @click="mobileSidebarOpen = false"
                                   class="group flex items-center rounded-md px-2.5 py-2 text-xs font-medium transition-all duration-150 <?php echo e($active ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300 shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-900 dark:hover:text-gray-200'); ?>">
                                    <svg class="mr-2.5 h-4 w-4 flex-shrink-0 <?php echo e($active ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-400 group-hover:text-gray-500 dark:group-hover:text-gray-300'); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="<?php echo e($item['icon']); ?>"/>
                                    </svg>
                                    <?php echo e($item['label']); ?>
