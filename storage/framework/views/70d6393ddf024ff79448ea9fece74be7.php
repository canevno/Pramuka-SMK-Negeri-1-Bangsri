                ...
                <div class="flex gap-8">
                    ...
                    >
                        ...
                        >
                            ...
                            <a href="<?php echo e(route('pembina')); ?>#anggota-dewan" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Anggota Dewan</a>
                ...
                <div class="mt-6 space-y-3 pb-6">
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 overflow-hidden">
                        ...
                        <div x-show="mobileOrgOpen" x-transition class="space-y-1 border-t border-slate-200 dark:border-slate-800 px-4 py-2">
                            ...
                            <a href="<?php echo e(route('pembina')); ?>#anggota-dewan" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Anggota Dewan</a>
