            ...
            <div class="flex items-center justify-center h-14">
                <div class="flex gap-8">
                    ...
                    >
                        ...
                        >
                            <a href="<?php echo e(route('pembina')); ?>" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Pembina</a>
                            <a href="<?php echo e(route('dewan-kehormatan')); ?>" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Dewan Kehormatan</a>
                            <a href="<?php echo e(route('dewan-ambalan')); ?>" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Dewan Ambalan</a>
                            <a href="<?php echo e(route('anggota-dewan')); ?>" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Anggota Dewan</a>
                            <a href="<?php echo e(route('mitra')); ?>" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Mitra</a>
                    ...
                    >
                        ...
                        >
                            <a href="<?php echo e(route('prestasi.ranting')); ?>" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Tingkat Ranting</a>
                            <a href="<?php echo e(route('prestasi.cabang')); ?>" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Tingkat Cabang</a>
                            <a href="<?php echo e(route('prestasi.jateng')); ?>" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Tingkat Daerah</a>
                            <a href="<?php echo e(route('prestasi.nasional')); ?>" class="block rounded-none px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white">Tingkat Nasional</a>
                        </div>
                    </div>
                    <div
                        class="relative"
                ...
                <div class="mt-6 space-y-3 pb-6">
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 overflow-hidden">
                        ...
                        <div x-show="mobileOrgOpen" x-transition class="space-y-1 border-t border-slate-200 dark:border-slate-800 px-4 py-2">
                            <a href="<?php echo e(route('pembina')); ?>" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Pembina</a>
                            <a href="<?php echo e(route('dewan-kehormatan')); ?>" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Dewan Kehormatan</a>
                            <a href="<?php echo e(route('dewan-ambalan')); ?>" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Dewan Ambalan</a>
                            <a href="<?php echo e(route('anggota-dewan')); ?>" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Anggota Dewan</a>
                            <a href="<?php echo e(route('mitra')); ?>" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Mitra</a>
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 overflow-hidden">
                        ...
                        <div x-show="mobilePrestasiOpen" x-transition class="space-y-1 border-t border-slate-200 dark:border-slate-800 px-4 py-2">
                            <a href="<?php echo e(route('prestasi.ranting')); ?>" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Tingkat Ranting</a>
                            <a href="<?php echo e(route('prestasi.cabang')); ?>" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Tingkat Cabang</a>
                            <a href="<?php echo e(route('prestasi.jateng')); ?>" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Tingkat Jateng</a>
                            <a href="<?php echo e(route('prestasi.nasional')); ?>" @click="mobileMenuOpen = false" class="block rounded-xl px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-slate-100 dark:text-gray-200 dark:hover:bg-slate-800">Tingkat Nasional</a>
                        </div>
                    </div>
