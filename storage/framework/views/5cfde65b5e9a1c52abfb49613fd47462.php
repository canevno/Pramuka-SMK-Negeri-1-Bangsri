        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-5 items-start">
            ...
            <main class="order-1 lg:order-2 lg:col-span-8 xl:col-span-9">
                ...
                <section x-show="activeTab === 'ambalan-sartika'" x-cloak class="pb-2 sm:pb-12 space-y-6">
                    <div class="flex justify-center">
                        <div class="overflow-hidden rounded-2xl bg-transparent p-1">
                            <img src="<?php echo e(asset('images/logos/dslogo.png')); ?>" alt="Logo Ambalan Dewi Sartika" class="mx-auto h-[180px] w-full max-w-[180px] object-contain sm:h-[220px] sm:max-w-[220px]">
                        </div>
                    </div>
