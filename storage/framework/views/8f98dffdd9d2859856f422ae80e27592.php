...
<div class="fixed inset-x-0 bottom-0 z-[60] lg:hidden">
    <div class="flex items-center justify-between gap-1 border-t border-slate-700 bg-[#0D1B2A] px-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2 shadow-[0_-8px_20px_rgba(15,23,42,0.28)]" style="padding-bottom: calc(0.5rem + env(safe-area-inset-bottom));">
        <a href="<?php echo e(route('home')); ?>" aria-current="<?php echo e($mobileNavActiveHome ? 'page' : 'false'); ?>" class="flex flex-1 flex-col items-center justify-center gap-1 rounded-[14px] px-1 py-1.5 text-[10px] font-semibold transition-all duration-200 <?php echo e($mobileNavActiveHome ? 'text-white' : 'text-slate-300 hover:text-white'); ?>">
        ...
        <a href="<?php echo e(route('prestasi.ranting')); ?>" aria-current="<?php echo e($mobileNavActivePrestasi ? 'page' : 'false'); ?>" class="flex flex-1 flex-col items-center justify-center gap-1 rounded-[14px] px-1 py-1.5 text-[10px] font-semibold transition-all duration-200 <?php echo e($mobileNavActivePrestasi ? 'text-white' : 'text-slate-300 hover:text-white'); ?>">
            <svg class="h-5 w-5 <?php echo e($mobileNavActivePrestasi ? 'scale-110 drop-shadow-sm' : ''); ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="<?php echo e($mobileNavActivePrestasi ? '2.2' : '1.9'); ?>" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <span class="<?php echo e($mobileNavActivePrestasi ? 'font-bold' : 'font-semibold'); ?>">Prestasi</span>
        </a>

        <a href="<?php echo e(route('about')); ?>" aria-current="<?php echo e($mobileNavActiveProfil ? 'page' : 'false'); ?>" class="flex flex-1 flex-col items-center justify-center gap-1 rounded-[14px] px-1 py-1.5 text-[10px] font-semibold transition-all duration-200 <?php echo e($mobileNavActiveProfil ? 'text-white' : 'text-slate-300 hover:text-white'); ?>">
        ...
        <a href="<?php echo e(route('absensi.index')); ?>" aria-current="<?php echo e($mobileNavActiveAbsensi ? 'page' : 'false'); ?>" class="flex flex-1 flex-col items-center justify-center gap-1 rounded-[14px] px-1 py-1.5 text-[10px] font-semibold transition-all duration-200 <?php echo e($mobileNavActiveAbsensi ? 'text-white' : 'text-slate-300 hover:text-white'); ?>">
...
</div><?php /**PATH C:\Users\Lenovo\Pramuka01\resources\views/components/mobile-bottom-nav.blade.php ENDPATH**/ ?>