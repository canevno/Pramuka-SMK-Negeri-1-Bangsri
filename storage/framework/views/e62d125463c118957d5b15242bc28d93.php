...
<div class="min-h-screen bg-slate-50 text-slate-900 pt-8 pb-16 dark:bg-slate-950 dark:text-slate-50" x-data="{ selectedMember: <?php echo e($selectedMemberId); ?> }">
                ...
                <nav class="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    <div>
                        ...
                        <div class="space-y-1 mt-2">
                            <a href="<?php echo e(route('pembina')); ?>" class="block w-full rounded-lg px-3 py-1.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-950 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 <?php echo e(request()->routeIs('pembina') ? 'bg-slate-100 font-bold text-slate-950 dark:bg-slate-800 dark:text-white' : ''); ?>"><span>Pembina</span></a>
                            <a href="<?php echo e(route('dewan-kehormatan')); ?>" class="block w-full rounded-lg px-3 py-1.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-950 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 <?php echo e(request()->routeIs('dewan-kehormatan') ? 'bg-slate-100 font-bold text-slate-950 dark:bg-slate-800 dark:text-white' : ''); ?>"><span>Dewan Kehormatan</span></a>
                            <a href="<?php echo e(route('dewan-ambalan')); ?>" class="block w-full rounded-lg px-3 py-1.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-950 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 <?php echo e(request()->routeIs('dewan-ambalan') ? 'bg-slate-100 font-bold text-slate-950 dark:bg-slate-800 dark:text-white' : ''); ?>"><span>Dewan Ambalan</span></a>
                            <a href="<?php echo e(route('anggota-dewan')); ?>" class="block w-full rounded-lg px-3 py-1.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-950 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 <?php echo e(request()->routeIs('anggota-dewan') ? 'bg-slate-100 font-bold text-slate-950 dark:bg-slate-800 dark:text-white' : ''); ?>"><span>Anggota Dewan</span></a>
                            <a href="<?php echo e(route('mitra')); ?>" class="block w-full rounded-lg px-3 py-1.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-950 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 <?php echo e(request()->routeIs('mitra') ? 'bg-slate-100 font-bold text-slate-950 dark:bg-slate-800 dark:text-white' : ''); ?>"><span>Mitra</span></a>
                            <a href="<?php echo e(route('alumni')); ?>" class="block w-full rounded-lg px-3 py-1.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-950 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 <?php echo e(request()->routeIs('alumni') ? 'bg-slate-100 font-bold text-slate-950 dark:bg-slate-800 dark:text-white' : ''); ?>"><span>Alumni</span></a>
                        </div>
                    </div>
                </nav>
            </aside>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div @click="selectedMember = (selectedMember === <?php echo e($index); ?> ? null : <?php echo e($index); ?>)"
                                    ...
                                    <div class="relative overflow-hidden rounded-lg aspect-square bg-slate-100 dark:bg-slate-700">
                                        <img src="<?php echo e($image); ?>" alt="<?php echo e($member['name'] ?? 'Alumni'); ?>" class="w-full h-full object-cover transition duration-300"
                                    ...
                                    <div class="px-2 pt-2.5 pb-1">
                                        <h3 class="font-bold text-sm sm:text-base leading-tight transition-colors"
                                            :class="selectedMember === <?php echo e($index); ?> ? 'text-white' : 'text-slate-900 dark:text-slate-100'">
                                            <?php echo e($member['name'] ?? 'Nama'); ?>

                                        </h3>
                                        <p class="text-xs transition-colors mt-0.5"
                                           :class="selectedMember === <?php echo e($index); ?> ? 'text-sky-200' : 'text-slate-500 dark:text-slate-400'">
                                            <?php echo e($member['jabatan'] ?? 'Alumni'); ?>

                                        </p>
                                        <p class="mt-2 text-[11px] leading-relaxed transition-colors"
                                           :class="selectedMember === <?php echo e($index); ?> ? 'text-slate-200' : 'text-slate-600 dark:text-slate-300'">
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Pramuka01\resources\views/pages/alumni.blade.php ENDPATH**/ ?>