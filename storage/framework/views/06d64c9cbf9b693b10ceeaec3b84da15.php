    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-xl border border-slate-200 bg-slate-50 p-5 transition-colors dark:border-slate-700 dark:bg-slate-800/50">
                ...
                <p class="mt-3 text-3xl font-bold text-slate-900 dark:text-slate-100"><?php echo e(number_format($totalCount ?? 0)); ?></p>
            </div>
            <!-- Minggu Ini -->
            <div class="rounded-xl border border-slate-200 bg-slate-50 p-5 transition-colors dark:border-slate-700 dark:bg-slate-800/50">
                <p class="text-xs font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400">Minggu Ini</p>
                <p class="mt-3 text-3xl font-bold text-slate-900 dark:text-slate-100"><?php echo e(number_format($weeklyCount ?? 0)); ?></p>
                <p class="mt-2 text-xs font-medium text-slate-500 dark:text-slate-400"><?php echo e($currentWeekLabel ?? '-'); ?></p>
            </div>
            <!-- Bulan Ini -->
            <div class="rounded-xl border border-slate-200 bg-slate-50 p-5 transition-colors dark:border-slate-700 dark:bg-slate-800/50">
                <p class="text-xs font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400">Bulan Ini</p>
                <p class="mt-3 text-3xl font-bold text-slate-900 dark:text-slate-100"><?php echo e(number_format($monthlyCount ?? 0)); ?></p>
                <p class="mt-2 text-xs font-medium text-slate-500 dark:text-slate-400"><?php echo e($currentMonthKey ?? '-'); ?></p>
            </div>
            <!-- Tahun Ini -->
            <div class="rounded-xl border border-slate-200 bg-slate-50 p-5 transition-colors dark:border-slate-700 dark:bg-slate-800/50">
                <p class="text-xs font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400">Tahun Ini</p>
                <p class="mt-3 text-3xl font-bold text-slate-900 dark:text-slate-100"><?php echo e(number_format($yearlyCount ?? 0)); ?></p>
                <p class="mt-2 text-xs font-medium text-slate-500 dark:text-slate-400"><?php echo e($currentYear ?? '-'); ?></p>
            </div>
        </div>
    </section>
                    ...
                    <tbody class="divide-y divide-slate-200 bg-white dark:divide-slate-800 dark:bg-slate-900">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recapRecords ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                <td class="px-5 py-4 font-medium text-slate-900 dark:text-slate-200"><?php echo e($r['record_date']); ?></td>
                                <td class="px-5 py-4 text-slate-600 dark:text-slate-400"><?php echo e($r['kelas']); ?></td>
                                <td class="px-5 py-4 text-slate-600 dark:text-slate-400"><?php echo e($r['ambalan']); ?></td>
                                <td class="px-5 py-4 text-slate-600 dark:text-slate-400"><?php echo e($r['petugas']); ?></td>
                                <td class="px-5 py-4">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="rounded-xl border border-slate-200 bg-slate-50/50 p-4 dark:border-slate-800 dark:bg-slate-800/40">
                <div class="flex items-center justify-between border-b border-slate-200/60 pb-3 dark:border-slate-700/60">
                    ...
                    <span class="text-xs font-semibold text-slate-400 dark:text-slate-400"><?php echo e(now()->translatedFormat('F Y')); ?></span>
                </div>
                ...
                <div class="mt-3 overflow-x-auto">
                    <table class="w-full text-left text-xs text-slate-600 dark:text-slate-300">
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rekapPutra ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr class="hover:bg-slate-100/50 dark:hover:bg-slate-800/60">
                                    <td class="px-3 py-2.5 font-semibold text-slate-800 dark:text-slate-100"><?php echo e($row->participant_kelas); ?></td>
                                    <td class="px-3 py-2.5 text-center">
                                        <span class="rounded-full bg-blue-100/80 px-2.5 py-0.5 text-[10px] font-bold text-blue-600 dark:bg-blue-950/80 dark:text-blue-400">
                                            <?php echo e($row->total_sesi); ?> Sesi
                                        </span>
                                    </td>
                                    <td class="px-3 py-2.5 text-center">
                                        <button wire:click="openModalBulanan('<?php echo e($row->participant_kelas); ?>', 'Putra')" class="rounded-lg bg-emerald-50 px-2.5 py-1 text-[11px] font-medium text-emerald-600 hover:bg-emerald-100 dark:bg-emerald-950/40 dark:text-emerald-400 cursor-pointer">
                                            👁 Matriks
                                        </button>
                                    </td>
                                </tr>
            ...
            <div class="rounded-xl border border-slate-200 bg-slate-50/50 p-4 dark:border-slate-800 dark:bg-slate-800/40">
                ...
                <div class="mt-3 overflow-x-auto">
                    <table class="w-full text-left text-xs text-slate-600 dark:text-slate-300">
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rekapPutri ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr class="hover:bg-slate-100/50 dark:hover:bg-slate-800/60">
                                    <td class="px-3 py-2.5 font-semibold text-slate-800 dark:text-slate-100"><?php echo e($row->participant_kelas); ?></td>
                                    <td class="px-3 py-2.5 text-center">
                                    ...
                                    <td class="px-3 py-2.5 text-center">
                                        <button wire:click="openModalBulanan('<?php echo e($row->participant_kelas); ?>', 'Putri')" class="rounded-lg bg-emerald-50 px-2.5 py-1 text-[11px] font-medium text-emerald-600 hover:bg-emerald-100 dark:bg-emerald-950/40 dark:text-emerald-400 cursor-pointer">
                                            👁 Matriks
                                        </button>
                                    </td>
                                </tr>
    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 dark:border-slate-800">
            <table class="min-w-full divide-y divide-slate-200 text-left text-sm dark:divide-slate-800">
                ...
                <tbody class="divide-y divide-slate-200 bg-white dark:divide-slate-800 dark:bg-slate-900">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $petugas ?? $petugasList ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50">
                            <td class="px-5 py-4 font-semibold text-slate-900 dark:text-slate-100"><?php echo e($item->nama); ?></td>
                            <td class="px-5 py-4 font-mono text-xs text-slate-500 dark:text-slate-400"><?php echo e($item->nta); ?></td>
                            <td class="px-5 py-4 text-slate-600 dark:text-slate-400"><?php echo e($item->kelas_petugas); ?></td>
                            <td class="px-5 py-4">
                                <div class="flex items-center gap-3">
                                    <button type="button"
                                        onclick="togglePetugasStatus(this, '<?php echo e($item->id); ?>')"
                                        data-active="<?php echo e($item->is_active ? '1' : '0'); ?>"
                                        class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 <?php echo e($item->is_active ? 'bg-emerald-500' : 'bg-slate-300 dark:bg-slate-700'); ?>"
                                        role="switch"
                                        aria-checked="<?php echo e($item->is_active ? 'true' : 'false'); ?>">
                                        <span class="js-switch-thumb pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow-sm ring-0 transition duration-200 ease-in-out <?php echo e($item->is_active ? 'translate-x-5' : 'translate-x-0'); ?>"></span>
                                    </button>
                                    <span class="js-status-label text-xs font-semibold <?php echo e($item->is_active ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-400 dark:text-slate-500'); ?>">
                            ...
                            <td class="px-5 py-4 text-xs text-slate-500 dark:text-slate-400">
                                <?php echo e($item->terakhir_melakukan ? \Carbon\Carbon::parse($item->terakhir_melakukan)->translatedFormat('d M Y, H:i') : 'Belum Pernah'); ?>
                            ...
                            <td class="px-5 py-4 text-center">
                                <span class="inline-flex items-center justify-center rounded-full bg-slate-100 px-2.5 py-1 text-xs font-bold text-slate-700 dark:bg-slate-800 dark:text-slate-300">
                                    <?php echo e($item->jumlah_rekam ?? $item->rekam_count ?? 0); ?>
    ...
    <div class="w-full max-w-2xl rounded-2xl bg-white shadow-2xl border border-slate-200 flex flex-col max-h-[90vh] dark:bg-slate-900 dark:border-slate-800">
        ...
        <div class="flex items-center justify-end gap-2 border-t border-slate-200 bg-slate-50 px-6 py-4 dark:border-slate-800 dark:bg-slate-800/50">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($absensi) && $absensi->id): ?>
                <a href="<?php echo e(route('admin.absensi.exportWord', $absensi->id)); ?>" class="inline-flex items-center gap-1.5 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700">
            ...
            <a href="<?php echo e(route('admin.absensi.export', $absensi->id ?? null)); ?>" class="inline-flex items-center gap-1.5 rounded-lg bg-emerald-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-emerald-700">
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                Excel
            </a>
...
<div id="modalTambahPetugas" class="fixed inset-0 z-50 hidden items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm">
    <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl border border-slate-200 dark:bg-slate-900 dark:border-slate-800">
        ...
        <form method="POST" action="<?php echo e(route('admin.petugas.store')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
