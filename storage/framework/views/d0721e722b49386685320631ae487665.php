...
>
    <template x-if="!supported">
        <flux:text><?php echo e(__('Passkeys are not supported in this browser.')); ?></flux:text>
    </template>
    ...
    <template x-if="supported && showForm">
        <div class="space-y-4 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50 p-4">
            <flux:input
                label="<?php echo e(__('Passkey name')); ?>"
                x-model="name"
                placeholder="<?php echo e(__('e.g., MacBook Pro, iPhone')); ?>"
                x-on:keydown.enter.prevent="register()"
                x-ref="passkeyNameInput"
                x-init="$nextTick(() => $refs.passkeyNameInput?.focus())"
            />
            <flux:text class="!mt-1"><?php echo e(__('Give this passkey a name to help you identify it later.')); ?></flux:text>
...
<?php /**PATH C:\Users\Lenovo\Pramuka01\resources\views\components\passkey-registration.blade.php ENDPATH**/ ?>