...
<div class="p-6">
    ...
    <!-- Detail Modal is rendered via the layout modal stack (<?php echo $__env->yieldPushContent('modals'); ?>) -->
                    ...
                    <tr data-rt="<?php echo e(e($item->rt)); ?>" data-rw="<?php echo e(e($item->rw)); ?>" data-kecamatan="<?php echo e(e($item->kecamatan)); ?>" data-kabupaten="<?php echo e(e($item->kabupaten)); ?>" data-ttl="<?php echo e(e($item->tempat_tanggal_lahir)); ?>" data-motivasi="<?php echo e(e($item->motivasi)); ?>" class="bg-white border-b hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800/50">
                        ...
                        <td class="py-4 px-4 align-middle">
                            ...
                            ?>
                                ...
                                <a href="<?php echo e(route('admin.pendaftaran.download', $item->id)); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center px-3 py-1.5 text-xs font-medium text-emerald-700 bg-emerald-100 rounded hover:bg-emerald-200 whitespace-nowrap min-w-24 dark:text-emerald-300 dark:bg-emerald-900/30 dark:hover:bg-emerald-900/50">
                        ...
                        <td class="py-4 px-4 text-center">
                            <form action="<?php echo e(route('admin.pendaftaran.updateStatus', $item->id)); ?>" method="POST" class="inline-flex items-center space-x-1">
                                <?php echo csrf_field(); ?>
