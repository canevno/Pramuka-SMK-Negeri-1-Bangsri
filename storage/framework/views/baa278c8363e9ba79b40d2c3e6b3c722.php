    ...
    <div class="rounded-xl border border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-500/30 dark:bg-emerald-500/10">
        <div class="flex gap-3">
            ...
            <div class="flex-1">
                ...
                <p class="mt-0.5 text-sm text-emerald-800 dark:text-emerald-200">Setiap perubahan data alumni akan langsung tampil di <a href="<?php echo e(route('alumni')); ?>" class="font-semibold underline hover:no-underline">halaman alumni publik</a>.</p>
            </div>
        </div>
    </div>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <button type="button" onclick="document.getElementById('edit-alumni-<?php echo e($member->id); ?>').classList.toggle('hidden')" class="rounded-lg border border-emerald-200 bg-emerald-50 px-2.5 py-1.5 text-[10px] font-semibold text-emerald-700 hover:bg-emerald-100 dark:border-emerald-500/40 dark:bg-emerald-500/10 dark:text-emerald-300 dark:hover:bg-emerald-500/20">
                                        Edit
                                    </button>
